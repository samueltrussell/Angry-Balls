...
{
    class BrickExplosion
    {

        private int numParticles = 20;
        private double angularSpacing; //degrees between particles
        private static int radius = 10; //particle body radius in pixel space
        ...
        public BrickExplosion(World world, float intensity, Vector2 position) //position denotes location IN SIM SPACE
        {
            particleList = new List<Body>();
            destructorWorld = world;
            particleImage = Game1.brickParticleImage;
